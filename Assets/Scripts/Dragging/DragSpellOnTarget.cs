...
public class DragSpellOnTarget : DraggingActions {
    ...
    public override void OnEndDrag()
    {
        ...
        {
            if (h.transform.tag.Contains("EmptySpace"))
            {
                // selected an empty space
                Target = h.transform.gameObject;
                Debug.Log("Hit an empty space");
            }
            else 
            {
                // hit a creature, save parent transform
                Target = h.transform.gameObject;
                Debug.Log("Hit a " + Target.ToString());
            }
        }
        ...
        if (Target != null)
        {
            ...
            if (Target.tag.Contains("EmptySpace"))
            {
                targetValid = true;
            }
            else if (Target.tag.Contains("Card"))
            {
                targetValid = true;
            }
